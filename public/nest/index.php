...
<link rel="stylesheet" href="css/nest-layout.css?v=28">
...
<?php if ($urlUsername): ?>
  ...
  <aside class="nest-sidebar">
    ...
    <!-- Navigation content - categories with posts -->
    <div id="nest-navigation-content" class="nest-sidebar-content">
...
<script type="module" src="js/nest.js?v=82"></script>
</body>
</html>
